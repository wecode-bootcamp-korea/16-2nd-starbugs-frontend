...
const HEAD1 = [
  {
    ...
    title: "커피",
    content: [
      { menu_title: "스타벅스 원두", menu_link: "/" },
      { menu_title: "스타벅스 비아", menu_link: "/" },
      { menu_title: "스타벅스 오리가미", menu_link: "/" },
    ],
    link: "/login",
  },
  {
...
const HEAD2 = [
  {
    ...
    title: "음료",
    content: [
      { menu_title: "콜드 브루", menu_link: "/cold-brew" },
      { menu_title: "에스프레소", menu_link: "/" },
      { menu_title: "프라프치노", menu_link: "/" },
      { menu_title: "콜드 브루", menu_link: "/" },
      { menu_title: "블랜디드", menu_link: "/" },
      { menu_title: "스타벅스 파지오", menu_link: "/" },
    ],
    link: "/login",
  },
  {
